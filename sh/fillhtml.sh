...
hash=$(sha1sum -b "img/all.png" | cut -c1-40 | base64 | cut -c3-8)
cp img/all.png build/img/${hash}.png
touch --date="${constDate}" build/img/${hash}.png
perl -0777 -i -pe "s#img/lugano.png#img/${hash}.png#" build/tmp.html
